...
class UploadImageException(message: String) : IdentityException(message)
class DeleteImageException(message: String) : IdentityException(message)
class NotFoundException(message: String) : IdentityException(message)